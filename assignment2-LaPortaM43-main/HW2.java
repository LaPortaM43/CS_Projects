...
public class HW2 {
    ...
    public static void main(String[] args) {
        ...
        // Verify one and only one command line argument is supplied
    	
        if (args.length != HW2Constants.NUMBEROFARGUMENTS) {
            System.err.println("Error: One command line argument required");
            System.exit(HW2Constants.WRONGARGUMENTS);
        }
        
        if (!args[0].equals(HW2Constants.DEVELOPMENT)) {
            PrintStream newIO;
            try {
